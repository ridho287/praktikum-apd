...
def validasi(pilih, valid, rekursif=False):
    try:
        ...
        if user_input in valid:
            ...
            if rekursif:
                return validasi(pilih, valid, rekursif)
            else:
                return None
...
while True:
    menu_utama()
    pilih = validasi("Pilih menu (1/2/3): ", ["1", "2", "3"], rekursif=True)
...
clear_terminal()
print(f"Selamat datang, {username.upper()}! Anda login sebagai {role.upper()}.\n")

if role == "admin":
    while True:
        menu_admin()
        pilih = validasi("Pilih menu: ", ["1", "2", "3", "4", "5"], rekursif=True)
...
==================================================
""")
        pilih = validasi("Pilih menu: ", ["1", "2", "3"], rekursif =True)
